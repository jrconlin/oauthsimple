...
following languages are supported: PHP, Javascript. I'd love to add additional
languages and may do so in the future. (I'd be happy to accept contributions, 
hint, hint.)

Guido Schlabitz has provided a useful example for how to use L<<a href="blob/master/php/example.php">OAuthSimple to connect to Google</a>>
...
L<<a href="http://github.com/itrelease/oauthsimple">Anton Byrna's fork</a>>
